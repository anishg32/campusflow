    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-foreground rounded-xl font-bold hover:scale-105 transition-transform flex items-center gap-2 shadow-lg shadow-indigo-500/20"
        >
          <Plus size={18} />
          Add Department
        </button>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-foreground font-bold text-lg hover:opacity-90 transition-all mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
