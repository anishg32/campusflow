...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex bg-background font-sans selection:bg-primary/30">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-950 relative flex-col justify-between p-12 overflow-hidden text-white border-r border-white/5">
        {/* Background Elements */}
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            <span className="font-bold text-2xl tracking-tight text-white block leading-tight">CampusFlow</span>
            <span className="text-xs uppercase tracking-widest text-white/50 font-semibold">Enterprise ERP</span>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-lg mt-20">
          ...
          >
            ...
            <div className="flex items-center gap-4 text-white/50 bg-white/5 p-4 rounded-2xl border border-white/10 backdrop-blur-md w-fit">
              <ShieldCheck className="w-8 h-8 text-green-400/80" />
              <div className="text-sm">
                <p className="text-white/80 font-medium">Enterprise Security</p>
        ...
        <div className="relative z-10 flex items-center gap-4 text-sm text-white/40">
